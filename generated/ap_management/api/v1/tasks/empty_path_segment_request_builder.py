...
if TYPE_CHECKING:
    ...
    from ....models.create_task_input import CreateTaskInput
...
class EmptyPathSegmentRequestBuilder(BaseRequestBuilder):
    ...
    async def post(self,body: CreateTaskInput, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[CreatePayload]:
        """
    ...
    def to_post_request_information(self,body: CreateTaskInput, request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> RequestInformation:
        """
        Registers a new Task
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
