...
class ApExecutorClient(BaseRequestBuilder):
    """
    The main entry point of the SDK, exposes the configuration and the fluent API.
    """
    def __init__(self,request_adapter: RequestAdapter) -> None:
        """
        Instantiates a new ApExecutorClient and sets the default values.
    ...
    @dataclass
    class ApExecutorClientGetRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
